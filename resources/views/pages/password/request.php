...
<section class="section--page-title section--page-title-compact">
    <div class="page-title page-title--card page-title--split page-title--compact">
        <div class="page-title__main">
            ...
            <h1 class="page-title__title">Passwort vergessen</h1>
            <p class="page-title__lead">Fordere einen Reset-Link für dein Konto an.</p>
        </div>
...
<?php endif; ?>
    ...
    <form class="form form--card" method="post" action="/passwort/vergessen">
        <input type="hidden" name="_csrf_token" value="<?= $e($csrfToken) ?>">
        <div class="form__grid form__grid--1">
            <div class="form__field">
                <label class="form__label" for="email">E-Mail</label>
                <input class="form__control" id="email" type="email" name="email" required autocomplete="email">
            </div>
            <div class="form__actions">
                <button class="btn btn--primary" type="submit">Reset-Link anfordern</button>
                <a class="btn btn--outline" href="/login">Zum Login</a>
            </div>
        </div>
    </form>
</section>

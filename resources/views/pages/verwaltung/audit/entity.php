...
$entityTitle = (string) ($entityTitle ?? $pageTitle ?? 'Audit-Timeline');
$backUrl = (string) ($backUrl ?? '/verwaltung/audit');
?>
...
<section class="section--page-title section--page-title-compact">
    <div class="page-title page-title--card page-title--split page-title--compact">
        <div class="page-title__main">
            ...
            <h1 class="page-title__title"><?= $e($entityTitle) ?></h1>
            <p class="page-title__lead">Audit-Timeline für diese Entität.</p>
        </div>
        <div class="page-title__side"><div class="page-title__actions btn-group"><a class="btn btn--outline" href="<?= $e($backUrl) ?>">Zurück</a></div></div>
    </div>
</section>

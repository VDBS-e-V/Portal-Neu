...
<section class="section--page-title section--page-title-compact">
    <div class="page-title page-title--card page-title--split page-title--compact">
        <div class="page-title__main">
            ...
            <h1 class="page-title__title">Adressen: <?= $e($label) ?></h1>
            <p class="page-title__lead">Post- und Rechnungsadressen der Person verwalten.</p>
        </div>
...
<section>
    <form class="form form--card" method="post" action="/verwaltung/personen/<?= $personId ?>/adressen">

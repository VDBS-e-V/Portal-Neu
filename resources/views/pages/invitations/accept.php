...
$errors = $errors ?? [];
$label = trim((string) ($invitation['person_display_name'] ?? $invitation['email'] ?? ''));
?>
...
<section class="section--page-title section--page-title-compact">
    <div class="page-title page-title--card page-title--split page-title--compact">
        <div class="page-title__main">
            <p class="page-title__kicker">Einladung</p>
            <h1 class="page-title__title">Einladung annehmen</h1>
            <p class="page-title__lead">Lege ein Passwort fest, um deinen Account zu aktivieren.</p>
        </div>
...
<?php endif; ?>
    ...
    <form class="form form--card" method="post" action="/einladung/<?= $e(rawurlencode($token)) ?>">
        <div class="form__grid form__grid--1">
            <?php if ($label !== ''): ?>
                <div class="form__notice form__notice--info">Einladung für: <?= $e($label) ?></div>
            <?php endif; ?>
            ...
            <div class="form__actions">
                <button class="btn btn--primary" type="submit">Einladung annehmen</button>
            </div>
        </div>
    </form>
</section>

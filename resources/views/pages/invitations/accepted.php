...
<section class="section--page-title section--page-title-compact">
    <div class="page-title page-title--card page-title--split page-title--compact">
        <div class="page-title__main">
            ...
            <h1 class="page-title__title">Account aktiviert</h1>
            <p class="page-title__lead">Die Einladung wurde angenommen. Der Login ist jetzt möglich.</p>
        </div>
        <div class="page-title__side"><div class="page-title__actions btn-group"><a class="btn btn--primary" href="/login">Zum Login</a></div></div>
    </div>
</section>
